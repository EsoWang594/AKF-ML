...
void loop() {
    ...
    // ---- KHỐI XỬ LÝ CHÍNH ----
    if (is_running) {
        float raw_accZ = read_raw_sensor(); // Đọc dữ liệu từ MPU6050 thật
        ...
        if (ram_consumed_kb <= 0.0) {
            ram_consumed_kb = (float)(sizeof(gru_input_history) + 256) / 1024.0; 
        }
        ...
        Serial.print(" | Tho: ");           Serial.print(raw_accZ, 2);
        Serial.print(" | Loc UKF: ");      Serial.print(filtered_accZ, 2);
